...
### 3. Обработка пропусков и Feature Encoding
...
- **OrdinalEncoder и OneHotEncoder** — кодирование категориальных признаков.
- **PolynomialFeatures** — создание полиномиальных и производных признаков.
